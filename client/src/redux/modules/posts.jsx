...
export const getPosts = () => async dispatch => {
  ...
  export const deletePost = id => async dispatch => {
    try {
     ...
     // dispatch(console.log('Post Removed success'));
    } catch (err) {
      dispatch({
        type: POST_ERROR,
        payload: { msg: err.response.statusText, status: err.response.status }
  ...
  export const addPost = formData => async dispatch => {
    try {
     ...
     // dispatch(console.log('Post Created success'));
    } catch (err) {
      dispatch({
        type: POST_ERROR,
        payload: { msg: err.response.statusText, status: err.response.status }
  ...
  export const addComment = (postId, formData) => async dispatch => {
    try {
     ...
     // dispatch(console.log('Comment Added success'));
    } catch (err) {
      dispatch({
        type: POST_ERROR,
        payload: { msg: err.response.statusText, status: err.response.status }
  ...
  export const deleteComment = (postId, commentId) => async dispatch => {
    try {
      ...
      //dispatch(console.log('Comment Removed success'));
    } catch (err) {
      dispatch({
        type: POST_ERROR,
        payload: { msg: err.response.statusText, status: err.response.status }

...
export const createProfile = (formData, history, edit= false) => async (dispatch) => {
    try {
        ...
        //dispatch(console.log(edit ? "Profile Updated" : "Profile Created", "success"));
        ...
        // if (errors) {
        //     errors.forEach(error => dispatch(console.log(error.msg + "error")))
        // }
...
export const addExperience = (formData, history) => async (dispatch) => {
    try {
        ...
        //dispatch(console.log("Experience added" + " success"));
...
export const addEducation = (formData, history) => async (dispatch) => {
    try {
       ...
       // dispatch(console.log("Education added", "success"));
...
export const deleteExperience = (id) => async (dispatch) => {
    try {
       ...
       // dispatch(console.log("Experience removed", "success"));
    } catch (err) {
        dispatch({
            type: PROFILE_ERROR,
            payload: {msg: err.response.statusText, status: err.response.status}
...
export const deleteEducation = (id) => async (dispatch) => {
    try {
       ...
       // dispatch(console.log("Education removed", "success"));
    } catch (err) {
        dispatch({
            type: PROFILE_ERROR,
            payload: {msg: err.response.statusText, status: err.response.status}
...
export const deleteAccount = () => async (dispatch) => {
    if (window.confirm('Are you sure? This can NOT be undone!')) {
      try {
       ...
       // dispatch(console.log('Your account has been permanently deleted'));
      } catch (err) {
        dispatch({
          type: PROFILE_ERROR,
          payload: { msg: err.response.statusText, status: err.response.status }
